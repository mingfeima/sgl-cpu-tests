...
def run_single_test(m, n, k, routed_scaling_factor, dtype, prepack=False):
    ...
    res = shared_expert(hidden_states, w1, w2, fused_output, routed_scaling_factor, True, False, False, None, None, None, False)
    ...
    res2 = shared_expert(hidden_states2, w1_q, w2_q, fused_output, routed_scaling_factor, True, True, False, w1_s, w2_s, None, False)
